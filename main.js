...
for(i=0; i<4; i++){
   ...
   function addHandler(btn, move, pk1, pk2){
      btn.addEventListener('click', function(e){
         ...
         setTimeout(attack, 1000, pk2.moves[Math.floor(Math.random()*3)], pk2, pk1, 'hp1', 'Foe ');
      });
   }
         ...
         if(rtype[i].includes(mtype)){
            switch(i){
               ...
               case 1:
                  scale = 2;
                  setTimeout(function(){
                     document.getElementById('comment').innerHTML = '<p>It was very effective!</p>';
                  },2000);
                  break;
               case 2:
                  scale = 0.5;
                  setTimeout(function(){
                     document.getElementById('comment').innerHTML = '<p>It caused minor damage!</p>';
                  },2000);
                  break;
            }
            break; 
